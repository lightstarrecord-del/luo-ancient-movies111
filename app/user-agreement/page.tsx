      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-8">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-gray-300 mb-6">
            By using LUO ANCIENT MOVIES, you agree to be bound by the following terms and conditions.
          </p>
          ...
          <p className="text-gray-300 mb-4">
            Permission is granted to temporarily download one copy of the materials on LUO ANCIENT MOVIES for personal,
            non-commercial transitory viewing only.
          </p>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4">Disclaimer</h2>
          <p className="text-gray-300 mb-4">
            The materials on LUO ANCIENT MOVIES are provided on an 'as is' basis. LUO ANCIENT MOVIES makes no warranties, expressed or
            implied.
          </p>
        </div>
      </div>
